        ...
        <section className="formCard">
          ...
          {step === 2 && <>
            ...
            <div className="grid2">
              ...
              <Field label="Color (profile-filtered)"><select value={color} onChange={e=>setColor(e.target.value)}>{colors.map(x=><option key={x} value={x}>{x}{inquiryColors.has(x)&&profile.id!=="two-and-a-half-corrugated"?" · inquire":""}</option>)}</select></Field>
