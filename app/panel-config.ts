...
export const panelProfiles: PanelProfile[] = [
  ...
  { id: "tuff-rib", name: "Tuff Rib", coverages: ["36 in"], materials: [ARMORTECH(["29 ga", "26 ga"])], group: "S2", sourceUrl: "https://taylormetal.com/products/exposed-fastener-panels/tuff-rib/" },
  { id: "t-3", name: "T-3™", coverages: ["36 in"], materials: [ARMORTECH(["29 ga", "26 ga"]), KYNAR_500_STEEL("43 in"), WITH_SPECIAL(KYNAR_500_ALUMINUM("43 in"), [".040″ Aluminum"])], note: "Standard or wall profile", group: "S2", sourceUrl: "https://taylormetal.com/products/exposed-fastener-panels/t-3/" },
  { id: "pbr", name: "PBR", coverages: ["36 in"], materials: [ARMORTECH(["29 ga", "26 ga"]), KYNAR_500_STEEL("43 in"), WITH_SPECIAL(KYNAR_500_ALUMINUM("43 in"), [".040″ Aluminum"])], group: "S4", sourceUrl: "https://taylormetal.com/products/exposed-fastener-panels/pbr/" },
  ...
  { id: "gr-7", name: "GR-7™", coverages: ["36 in"], materials: [ARMORTECH(["29 ga", "26 ga"]), WITH_SPECIAL(KYNAR_500_STEEL("43 in"), ["20 ga", "18 ga"]), WITH_SPECIAL(KYNAR_500_ALUMINUM("43 in"), [".040″ Aluminum", ".050″ Aluminum", ".063″ Aluminum"])], group: "S2", sourceUrl: "https://taylormetal.com/products/exposed-fastener-panels/gr-7/" },
